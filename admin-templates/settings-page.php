<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper wp-clearfix">
        <?php foreach ( $tabs as $tab ) : ?>
            <a class="nav-tab<?php if ( $active_tab == $tab['slug'] ) echo ' nav-tab-active'; ?>" href="options-general.php?page=wicked_folders_settings&tab=<?php echo $tab['slug']; ?>"><?php echo $tab['label']; ?></a>
        <?php endforeach; ?>
    </h2>
    <div class="wicked-settings wicked-clearfix">
        ...
        <div class="wicked-right">
            <div class="wicked-logo">
                <a href="https://wickedplugins.com/" target="_blank"><img src="<?php echo plugin_dir_url( dirname( __FILE__ ) ); ?>images/wicked-plugins-logo.png" alt="Wicked Plugins" width="300" height="223" /></a>
            </div>
            ...
            <?php if ( ! $is_pro_active && Wicked_Folders::is_upsell_enabled() ) : ?>
                ...
                <p class="wicked-pro-screenshot"><a href="https://wickedplugins.com/plugins/wicked-folders/" target="_blank"><img src="<?php echo plugin_dir_url( dirname( __FILE__ ) ); ?>images/media-library-folders.jpg" alt="<?php esc_attr_e( 'Screenshot of media library using Wicked Folders Pro', 'wicked-folders' ); ?>" width="800" height="465" /></a></p>
                <p><?php _e( 'Upgrade to <a href="https://wickedplugins.com/plugins/wicked-folders/" target="_blank">Wicked Folders Pro</a> to organize your media library using folders!', 'wicked-folders' ); ?></p>
                <hr />
            <?php endif; ?>
